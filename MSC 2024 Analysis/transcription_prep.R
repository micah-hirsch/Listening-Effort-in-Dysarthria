...
## (both raw and normalized pupil dfs). This data processing and analysis is 
## being completed for a poster presentation at the Motor Speech Conference 
## San Diego, CA in February 2024.
...
## Merging targets with transcriptions
phrase_acc <- targets |>
...
cleaned_data_normed <- pupil_normed |>
  dplyr::left_join(phrase_acc, by = c("subject", "trial", "targetphrase"))

# Removing unneeded items from the environment

rm(phrase_acc, pupil, pupil_normed, targets, transcriptions)

# Export csv file of cleaned data

rio::export(cleaned_data, "cleaned_data.csv")
rio::export(cleaned_data_normed, "cleaned_data_normed.csv")
