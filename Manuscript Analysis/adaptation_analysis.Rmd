...
control_acc <- vis.gam(adapt_pupil, view = c("time_norm", "trial_c"), 
        cond = list(condition = "Control Accurate"), 
        theta = -45, phi = 55, color = "topo")

control_inacc <- vis.gam(adapt_pupil, view = c("time_norm", "trial_c"), 
        cond = list(condition = "Control Inaccurate"), 
        theta = -45, phi = 55, color = "topo")

ALS_acc <- vis.gam(adapt_pupil, view = c("time_norm", "trial_c"), 
        cond = list(condition = "ALS Accurate"), 
        theta = -45, phi = 55, color = "topo")

ALS_inacc <- vis.gam(adapt_pupil, view = c("time_norm", "trial_c"), 
