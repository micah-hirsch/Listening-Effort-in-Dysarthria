...
Adding in AR(1) structure to address autocorrelation concerns. Bumped up knots to 25.
...
ggsave("Figures/difference_plots_speakers.png", plot = diff_plot_1, scale = 1.8)
