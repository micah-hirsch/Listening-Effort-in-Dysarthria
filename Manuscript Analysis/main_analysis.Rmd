...
Model residuals look better in model 2. Adjusted R-squared = 0.16
...
The model residuals look similar. The adjusted R-squared value is .177.
...
p1 <- m2_predicted_values |>
  dplyr::filter(condition == "Control Accurate" | condition == "ALS Accurate") |>
  ggplot() +
  aes(x = time_norm,
      y = fit,
      color = speaker,
...
p2 <- m2_predicted_values |>
  dplyr::filter(condition == "Control Accurate" | condition == "Control Inaccurate") |>
  ggplot() +
  aes(x = time_norm,
      y = fit,
      color = speaker,
  ...
  labs(x = "Normalized Time (ms)",
       ...
       linetype = "Repetition Accuracy") +
  scale_color_manual(values = c(my_pal[1]), guide = "none") +
  scale_fill_manual(values = c("#302853", "#7668B6")) +
...
p3 <- m2_predicted_values |>
  dplyr::filter(condition == "ALS Accurate" | condition == "ALS Inaccurate") |>
  ggplot() +
  aes(x = time_norm,
      y = fit,
      color = speaker,
  ...
  labs(x = "Normalized Time (ms)",
       ...
       fill = "Repetition Accuracy",
       linetype = "Repetition Accuracy") +
  scale_color_manual(values = c(my_pal[5]), guide = "none") +
  scale_fill_manual(values = c("#208371", "#4AD3BA")) +
  scale_linetype_manual(values = c("solid", "dashed"))
...
speaker_plot <- (p1 | diff_plot_1 ) + 
  plot_layout(guides = "collect") & 
  theme(legend.position = "bottom") 

speaker_plot <- speaker_plot +
  plot_annotation(title = "Speaker with ALS vs Neurotypical Speaker",
                  subtitle = "Controlling for Perceptual Accuracy \n(Accurate Trials Only)",
                  tag_levels = "A",
...
ggsave("Figures\\speaker_plot.png", speaker_plot, height = 7, width = 10, units = "in")
...
acc_plot <- (p2 | diff_plot_2 ) + 
  plot_layout(guides = "collect") & 
  theme(legend.position = "bottom") 

acc_plot <- acc_plot +
  plot_annotation(title = "Accurate Trials vs Inaccurate Trials",
                  subtitle = "Controlling for Speaker \n(Neurotypical Speaker Only)",
                  tag_levels = "A",
                  theme = theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"),
                                plot.subtitle = element_text(hjust = 0.5, size = 11)))
...
ggsave("Figures\\accuracy_plot.png", acc_plot, height = 7, width = 10, units = "in")
...
interaction_plot <- ((p2 | diff_plot_2) /
                      ( p3 | diff_plot_3)) + 
  plot_layout(guides = "collect") & 
  theme(legend.position = "none")

interaction_plot <- interaction_plot +
  plot_annotation(title = "Interaction between Speaker and Perceptual Accuracy",
                  tag_levels = "A",
                  theme = theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold")))

interaction_plot

ggsave("Figures\\interaction_plot.png", interaction_plot, height = 7, width = 7, units = "in")
