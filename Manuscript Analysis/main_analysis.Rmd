...
p1 <- m2_predicted_values |>
  ...
  labs(x = "Normalized Time (ms)",
       ...
       title = "A. Speaker with ALS vs \nNeurotypical Speaker") +
  scale_color_manual(values = c(my_pal[1], my_pal[5]), labels = c("Neurotypical", "ALS"))
...
p2 <- m2_predicted_values |>
  ...
  labs(x = "Normalized Time (ms)",
       ...
       fill = "Speaker",
       linetype = "Repetition Accuracy",
       title = "B. Neurotypical Speaker: \nAccurate vs Inaccurate Trials") +
...
ggsave("Figures\\full_pupil_plot.png", full_plot, height = 7, width = 12, units = "in")
